...
function App() {
  return (
    <div className="App">
      {/* <SuperHero name={SuperHeroes[0].name} url={SuperHeroes[0].url} /> */}
      {SuperHeroes.map((hero) => <SuperHero name={hero.name} universe={hero.universe} alterego={hero.alterego} occupation={hero.occupation} friends={hero.friends} superpowers={hero.superpowers} url={hero.url} info={hero.info} />)}
    </div>
  );
}
